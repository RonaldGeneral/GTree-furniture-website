    ...
    .then(data => {
        ...
        for(var x = 0; x < product.length; x++){
            ...
            document.getElementById("item"+x).addEventListener("click", function() {
                var pop = getIndex(this);
                addItem(pop, document.getElementById("quantity"+pop).value);});
            document.getElementById("quantity"+x).addEventListener("change", function() {addItem(x, document.getElementById("quantity"+x).value)});
            document.getElementById("delete"+x).addEventListener("click", function() {deleteItem(x, document.getElementById("quantity"+x).value)});
